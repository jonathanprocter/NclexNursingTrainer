    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Master diagnostic interpretation and clinical reasoning skills
        </p>
      </div>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview">
          <Card>
            <CardHeader>
              <CardTitle>Clinical Analysis Principles</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <Card className="p-4">
                    <h3 className="font-semibold mb-2">Diagnostic Interpretation</h3>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li>• Laboratory data analysis</li>
                      <li>• Imaging results interpretation</li>
                      <li>• Diagnostic testing protocols</li>
                      <li>• Reference range understanding</li>
                    </ul>
                  </Card>
                  <Card className="p-4">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <Card className="p-4">
                    <h4 className="font-medium mb-2">Cardiac Studies</h4>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                  ...
                  <Card className="p-4">
                    <h4 className="font-medium mb-2">Other Diagnostics</h4>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li>• Pulmonary function tests</li>
                      <li>• Sleep studies</li>
                      <li>• EEG interpretation</li>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <Card className="p-4">
                    <h4 className="font-medium mb-2">Common Labs</h4>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <AIHelpButton
                      description="Get AI assistance with lab value interpretation"
                      topic="lab_interpretation"
                      context="common_labs"
                    />
                  </Card>
                  <Card className="p-4">
                    <h4 className="font-medium mb-2">Specialized Tests</h4>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li>• Cardiac markers</li>
                      <li>• Endocrine studies</li>
                      <li>• Therapeutic drug levels</li>
                      <li>• Arterial blood gases</li>
                    </ul>
                     <AIHelpButton
                      description="Get AI assistance with specialized lab interpretation"
                      topic="specialized_labs"
                      context="advanced_interpretation"
                    />
                  </Card>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid gap-4">
                  <Card className="p-4">
                    <h4 className="font-medium mb-2">Systematic Assessment</h4>
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li>• Head-to-toe assessment</li>
                      <li>• System-specific examination</li>
                      <li>• Documentation requirements</li>
                      <li>• Critical findings recognition</li>
                    </ul>
                     <AIHelpButton
                      description="Get AI assistance with clinical assessment techniques"
                      topic="clinical_assessment"
                      context="systematic_approach"
                    />
                  </Card>
                </div>
              </div>
