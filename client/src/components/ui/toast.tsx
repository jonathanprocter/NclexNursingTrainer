  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium " +
        ...
        "group-[.destructive]:hover:border-destructive/40 group-[.destructive]:hover:bg-destructive " +
  ...
  <ToastPrimitives.Close
    ...
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 " +
        ...
        "group-hover:opacity-100 group-[.destructive]:text-destructive-foreground/50 " +
        "group-[.destructive]:hover:text-destructive-foreground",
      className
    )}
    toast-close=""
